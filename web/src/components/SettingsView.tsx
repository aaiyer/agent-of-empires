...
export function SettingsView({
  ...
  const sidebar: SidebarItem[] = mayaRestricted ? MAYA_SIDEBAR : cityhall ? CITYHALL_SIDEBAR : buildSidebar();
  ...
  useEffect(() => {
    // This is the authority boundary: Maya cannot query the profile catalog.
